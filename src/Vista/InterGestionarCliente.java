...
public class InterGestionarCliente extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.add(txt_ine, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 10, 170, -1));
    ...
    private void CargarTablaClientes() {
        ...
        try {
            ...
            model.addColumn("ine"); //se cambio por cedula
    ...
    private void EnviarDatosClienteSeleccionado(int idCliente) {
        try {
            ...
            if (rs.next()) {
                ...
                txt_ine.setText(rs.getString("ine"));
