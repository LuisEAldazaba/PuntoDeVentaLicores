...
public class InterGestionarVentas extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Administrar Venta");
    ...
    private void jButton_actualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_actualizarActionPerformed
        ...
        try{
            ...
            System.out.println("Error al cargar  el idCliente"+e);
        }
        
        //actualizaremos los datos
        if(!cliente.equalsIgnoreCase("Seleccione cliente:")){
            cabeceraVenta.setIdCliente(idCliente);
            if(estado.equalsIgnoreCase("Actico")){
    ...
    private void CargarTablaVentas() {
        ...
        try {
            ...
            model.addColumn("Fecha Venta"); //se cambio por cedula
...
//metodo enviar venta seleccionado 
    private void EnviarDatosVentaSeleccionada(int idVenta) {
        try {
            ...
            PreparedStatement pst = con.prepareStatement("select cv.idCabeceraVenta,cv.idCliente, concat(c.nombre, ' ',c.apellido)as cliente, "
                    ...
                    + "tb_cabecera_venta as cv, tb_cliente as c where cv.idCabeceraVenta='"+idVenta+ "' and cv.idCliente = c.idCliente;");
            ResultSet rs = pst.executeQuery();
