...
public class InterCliente extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(txt_ine, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 110, 170, -1));
        ...
        if (!txt_nombre.getText().isEmpty() && !txt_apellido.getText().isEmpty() && !txt_ine.getText().isEmpty()) {
            ...
            if (!controlCliente.existeCliente(txt_ine.getText().trim())) {
                ...
                if (controlCliente.guardar(cliente)) {
                    ...
                    txt_ine.setBackground(Color.green);
                ...
                txt_ine.setBackground(Color.white);
            ...
            txt_ine.setBackground(Color.red);
