...
public class InterGraficaVentas extends javax.swing.JInternalFrame {
    ...
    //metodo para determinar cual es el dia de mayor cantodad de ventas
    ...
    public void paint(Graphics g) {
        ...
        int mayorVentas = MetodoMayorVenta(listaCantidad);
        ...
        for (int i = 0; i < listaCantidad.size(); i++) {
            largo_NuevoIngreso = listaCantidad.get(i) * 400 / mayorVentas;
            if (i == 0) {
