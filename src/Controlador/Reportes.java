...
public class Reportes {
    ...
    public void ReportesClientes() {
        ...
        try {
            ...
            try {
                ...
                PreparedStatement pst = cn.prepareStatement("select idCliente, concat(nombre, ' ', apellido) as nombres, ine, telefono, direccion from tb_cliente");
    ...
    public void ReportesProductos() {
        ...
        try {
            ...
            float[] columnsWidths = {3, 4, 5,7 ,5 ,6, 4};
            ...
            try {
                Connection cn = conexion.Conexion.conectar();
                PreparedStatement pst = cn.prepareStatement("select p.idProducto, p.nombre, p.cantidad, p.precio,"
                        + " p.descripcion, p.porcentajeIva, c.descripcion as categoria, p.estado from tb_producto as p, "
    ...
    //metodo para crear reporte de las categorias registrados en el sistema
        ...
        try {
            ...
            try {
                ...
                PreparedStatement pst = cn.prepareStatement("select cv.idCabeceraVenta as id,"
                        ...
                        + "cv.fechaVenta as fecha, cv.estado from tb_cabecera_venta as cv, tb_cliente "
